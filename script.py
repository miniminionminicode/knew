...
# ---------------------------
BATCHES_URL = os.getenv("BATCHES_URL")  # e.g. https://sunnyji7256.github.io/kgs_batch_list/New_Sunny.json
API_BASE = os.getenv("API_BASE")        # e.g. https://kgs-dusky.vercel.app/api
